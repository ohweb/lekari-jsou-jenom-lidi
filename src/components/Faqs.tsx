      ...
      <Container className="relative">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Jaké jsou nejčastější otázky, kterým čelíme a mýty, které opakovaně
            vyvracíme? Zde naleznete odpovědi na nejčastější otázky o
            přesčasech, odpovědnosti za péči o pacienty, právních aspektech
            pracovních smluv a dalších klíčových tématech, které formují
            každodenní život zdravotnických pracovníků.
          </p>
        </div>
        <ul className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
          {faqs.map((column, columnIndex) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: There is no risk of this ever changing dynamically, since it is all defined in code.
            <li key={columnIndex}>
