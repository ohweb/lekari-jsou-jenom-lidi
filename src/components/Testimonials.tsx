...
const testimonial: OneTestimonial[][] = props.testimonials
            ...
            <Container>
                <div className="mx-auto max-w-2xl md:text-center">
                    ...
                    <p className="mt-4 text-lg tracking-tight text-slate-700">
                        Skutečné příběhy od Vás, lékařek a lékařů. Mladých i těch s letitými zkušenostmi se špatně
                        nastaveným systémem služeb, přesčasů a bezohledných požadavků na lékaře.
                    </p>
                </div>
                <ul
                    role="list"
