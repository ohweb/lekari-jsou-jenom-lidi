const posts = [
    ...
    {
        id: 2,
        title: 'Lorem ipsum dolor met sit amet',
        description: 'Těší nás, že pan ministr konečně otevřeně přiznává, že struktura příjmů lékařů, jejichž polovina pochází z přesčasové práce, je problém. Je nejvyšší čas s tím něco udělat. V zájmu udržitelnosti celého zdravotnictví je nutné zvýšení efektivity systému pomocí legislativních a ekonomických tlaků. A to nebude možné jinak než snižováním množství přesčasů a zvyšováním ceny práce lékaře v základní pracovní době.',
        date: '31. 10. 2023',
        datetime: '2023-10-31',
        category: { title: 'Marketing', href: '#' },
        author: {
